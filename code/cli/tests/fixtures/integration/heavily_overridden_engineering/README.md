...
1. a pre-seeded cached GitHub/team source in `home/.outfitter/cache/repos/`;
2. a repo-declared supplemental team source at `project/.outfitter/team-profiles/`;
3. the user's profile source at `home/.outfitter/profiles/`;
4. the checked-in repository source at `project/.outfitter/profiles/`;
5. project-local overrides at `project/.outfitter/local/profiles/`.
...
Generated Outfitter files such as `outfitter/profile.json` are transform outputs and are not written back to any source profile.
