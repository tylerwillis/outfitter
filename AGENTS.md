...
- When adding files or changing directory layout, first check `docs/file_structure.md` for current structure and update the relevant documentation afterward.
