...
→ resolving profile  engineering-default
  ...
  ✓ prepared tack    /tmp/bridl-engineering-default-pi-a91f
↳ launching pi …`}</pre>
      </div>
    </div>
  </section>
  ...
  <section className="bridl-section bridl-wrap bridl-showcase">
    <div>
      ...
      <div className="bridl-feature-list">
        ...
        <p><strong>Sync from anywhere</strong><br /><code>bridl sync</code> pulls remote settings and profile sources before a run.</p>
